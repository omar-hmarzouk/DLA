...
** Getting Chameleon
   ...
   The latest development state is available on [[https://gitlab.inria.fr/solverstack/chameleon][gitlab]]. To get
   Chamelon it from here you need [[https://git-scm.com/downloads][Git]]
   #+begin_src
